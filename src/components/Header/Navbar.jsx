...
class Navbar extends Component {
    ...
    menuClickHandler(){
        ...
        const changeDropdown = this.state.isDropdownMenu = !this.state.isDropdownMenu;
        ...
        <nav className="nav">
            <div className="container">
                ...
                <a href="#" className="nav__brand">
                    <img className="nav__brand-img" src="./assets/images/logo-crypto.png" alt="logo image"/>
                ...
                <ul className={`menu ${this.state.isMenuList ? "menu--open" : ""}`}>
                    ...
                    <li onClick={this.menuClickHandler.bind(this)} className={`menu__item menu__item-mobile--down ${this.state.isDropdownMenu ? "menu__item-mobile--open" : ""}`}><a href="#" className="menu__link menu__link--down">صفحات
                            <svg className="menu__down-icon" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 7L9 12L14 17" stroke="#637381" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg>
                        </a>
                ...
                <div className="nav-dark__btn" onClick={this.themeClickHandler.bind(this)}>
                    
                    <span className={`nav__moon ${!this.state.isTheme ? 'nav-dark__btn--active' : ''}`}>
                        <svg width="16" height="16" viewBox="0 0 16 16" stroke="#B5B3BC" fill="#B5B3BC">
                    ...
                    <span className={`nav__flicker ${this.state.isTheme ? 'nav-dark__btn--active' : ''}`}>
                        <svg width="13" height="15" viewBox="0 0 13 15" stroke="#B5B3BC" fill="#B5B3BC">
                ...
                <div className={`menu__btn ${this.state.isMenuList ? "menu-open__line--close" : ""}`} onClick={this.menuListShow.bind(this)}>{/*menu-open__line--close*/}
